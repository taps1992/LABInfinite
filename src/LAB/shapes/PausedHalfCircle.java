...
public class PausedHalfCircle extends AbstractShape implements Shape {

	public PausedHalfCircle() {
		name = "PausedHalfCircle"; 
		period = Math.PI * 6;
	}
	
	public Point draw(double length, double circleModifier, double realCircleAngle,  double circleTurnModifier) {

		double circleAngle = Math.abs (realCircleAngle % ((Math.PI * 3) + (Math.PI)));
